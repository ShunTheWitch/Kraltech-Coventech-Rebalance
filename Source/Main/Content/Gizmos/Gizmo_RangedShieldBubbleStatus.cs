...
public class Gizmo_RangedShieldBubbleStatus : Gizmo
{
    ...
    public Apparel_ShieldBubble shield;

    static Gizmo_RangedShieldBubbleStatus()
    {
    }

    public Gizmo_RangedShieldBubbleStatus()
    {
        Order = -100f;
    }
