...
public class Apparel_ShieldBubble : Apparel
{
    ...
    public override IEnumerable<Gizmo> GetWornGizmos()
    {
        ...
        yield return new Gizmo_RangedShieldBubbleStatus
        {
            shield = this
        };
    }
    ...
    public override bool CheckPreAbsorbDamage(DamageInfo dinfo)
    {
        ...
        else if (dinfo.Def == DamageDefOf.AntiHumanNanites)
        {
            energy = 0f;
            Break();
            result = false;
    ...
    public override void DrawWornExtras()
    {
        ...
        {
            var material = MaterialPool.MatFrom("Other/ShieldBubble_Strong", ShaderDatabase.Transparent);
