...
public class GameCondition_ToxicRain : GameCondition
{
    ...
    private readonly SkyColorSet ToxicFalloutColors = new(new ColorInt(216, 255, 0).ToColor, new ColorInt(234, 200, 255).ToColor, new Color(0.6f, 0.8f, 0.5f), 0.85f);
