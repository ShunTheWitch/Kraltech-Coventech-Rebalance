...
public class IncidentWorker_OrganicExterminationSquadAlpha : IncidentWorker
{
    private const float ShipPointsFactor = 1.5f;
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        IntVec3 intVec;
        CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.FabricatorPodIncoming, map, out intVec, 14, default, -1, false, true, true, true);
        var thing = ThingMaker.MakeThing(ThingDefOf.OverdrivenMechAssemblerAlpha);
        bool result;
        ...
        {
            var points = Mathf.Max(parms.points * 1.5f, 9000f);
            ...
            GenSpawn.Spawn(SkyfallerMaker.MakeSkyfaller(ThingDefOf.FabricatorPodIncoming, thing), intVec, map);
