...
public class IncidentWorker_OrganicExterminationSquadUltima : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        IntVec3 intVec;
        CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.HardFabricatorPodIncoming, map, out intVec, 14, default, -1, false, true, true, true);
        var thing = ThingMaker.MakeThing(ThingDefOf.OverdrivenMechAssemblerUltima);
        bool result;
