...
public class IncidentWorker_ADVColdSnapShip : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        IntVec3 intVec;
        CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.ADVColdSnapShipLanding, map, out intVec, 14, default, -1, false, true, true, true);
        var thing = ThingMaker.MakeThing(ThingDefOf.ADVColdSnapShip);
        bool result;
        ...
        else
        {
            ...
            LordMaker.MakeNewLord(Faction.OfMechanoids, new LordJob_MechanoidsDefend(new List<Thing>
            {
                thing
            ...
            GenSpawn.Spawn(SkyfallerMaker.MakeSkyfaller(ThingDefOf.ADVColdSnapShipLanding, thing), intVec, map);
