...
public class IncidentWorker_ADVHeatWaveShip : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        IntVec3 intVec;
        CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.ADVHeatWaveShipLanding, map, out intVec, 14, default, -1, false, true, true, true);
        var thing = ThingMaker.MakeThing(ThingDefOf.ADVHeatWaveShip);
        bool result;
        ...
        else
        {
            ...
            GenSpawn.Spawn(SkyfallerMaker.MakeSkyfaller(ThingDefOf.ADVHeatWaveShipLanding, thing), intVec, map);
