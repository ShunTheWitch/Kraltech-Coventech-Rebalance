...
public class IncidentWorker_EMIDynamoShip : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        IntVec3 intVec;
        CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.EMIShipLanding, map, out intVec, 14, default, -1, false, true, true, true);
        var thing = ThingMaker.MakeThing(ThingDefOf.EMIShipDynamoShip);
        bool result;
        ...
        else
        {
            ...
            GenSpawn.Spawn(SkyfallerMaker.MakeSkyfaller(ThingDefOf.EMIShipLanding, thing), intVec, map);
