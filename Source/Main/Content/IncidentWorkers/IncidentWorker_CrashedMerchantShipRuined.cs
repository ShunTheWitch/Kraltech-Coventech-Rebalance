...
public class IncidentWorker_CrashedMerchantShipRuined : IncidentWorker
{
    ...
    static IncidentWorker_CrashedMerchantShipRuined()
    {
    }
    ...
    {
        SkyfallerMaker.SpawnSkyfaller(ThingDefOf.MerchantShipCrashing, ThingDefOf.RuinedShipPart, pos, map);
    }
