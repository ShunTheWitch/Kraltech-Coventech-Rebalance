...
public class IncidentWorker_CrashedCargoShip : IncidentWorker
{
    private const float ShipPointsFactor = 0.9f;

    private const int IncidentMinimumPoints = 9000;

    private const float DefendRadius = 500f;
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        var thing = ThingMaker.MakeThing(ThingDefOf.CargoShuttleCrashed);
        bool result;
