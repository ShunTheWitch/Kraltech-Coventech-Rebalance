...
public class IncidentWorker_PsychicSuppresserShip : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        IntVec3 intVec;
        CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.DronerShipLanding, map, out intVec, 14, default, -1, false, true, true, true);
        var thing = ThingMaker.MakeThing(ThingDefOf.PsychicDronerShip);
        bool result;
        ...
        else
        {
            ...
            GenSpawn.Spawn(SkyfallerMaker.MakeSkyfaller(ThingDefOf.DronerShipLanding, thing), intVec, map);
